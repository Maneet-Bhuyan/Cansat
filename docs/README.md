...
* **[`architecture_and_ml.txt`](file:///e:/Cansat/docs/architecture_and_ml.txt)**: Comprehensive technical breakdown (written for 4th-year CSE / aerospace engineers) covering sensor kinematics, machine learning model architectures (Random Forest, PyOD Isolation Forest, Gradient Boosting), confusion matrices, and precision/recall evaluations.
