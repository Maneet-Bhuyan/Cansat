...
| Field | Detail |
|---|---|
| **File** | [`tinyml.html`](frontend/tinyml.html#L405), [`mission-slider.js`](frontend/js/mission-slider.js#L69), [`index.html`](frontend/index.html#L380) |
...
| **Safe for user to fix?** | [PASS] Yes — content-only change |
...
| Field | Detail |
|---|---|
| **File** | [`models.html:234`](frontend/models.html#L234) |
...
| Field | Detail |
|---|---|
| **File** | [`readme.md:369`](readme.md#L369) |
...
| Field | Detail |
|---|---|
| **File** | [`readme.md:371`](readme.md#L371) |
...
| Field | Detail |
|---|---|
| **File** | [`readme.md:374,383`](readme.md#L374), [`ml/README.md:7`](ml/README.md#L7) |
...
| Field | Detail |
|---|---|
| **File** | [`dashboard.html:6`](frontend/dashboard.html#L6) |
...
| Field | Detail |
|---|---|
| **File** | [`dashboard.html:577`](frontend/dashboard.html#L577) |
...
| Field | Detail |
|---|---|
| **File** | [`dashboard.html:890-892`](frontend/dashboard.html#L890) |
...
| **Safe for user to fix?** | [WARN] Verify first |
...
| Field | Detail |
|---|---|
| **File** | [`ml/README.md:13`](ml/README.md#L13) |
...
| Field | Detail |
|---|---|
| **File** | [`index.html:469`](frontend/index.html#L469) |
...
| Field | Detail |
|---|---|
| **File** | [`results.html:585`](frontend/results.html#L585) |
...
| Field | Detail |
|---|---|
| **File** | [`readme.md:368`](readme.md#L368) |
...
| Field | Detail |
|---|---|
| **File** | [`index.html:6`](frontend/index.html#L6) |
...
| Field | Detail |
|---|---|
| **File** | [`model_metrics.json:220-238`](ml/model_metrics.json#L220) |
...
|---|---|---|---|---|
| SPELL-01 | [`index.html:469`](frontend/index.html#L469) | 469 | "Precision Environmental Droplibs" | "Precision Environmental Sensing" (or Dropsondes) |
| SPELL-02 | [`results.html:585`](frontend/results.html#L585) | 585 | `Vallabhm, Ganesh` | `{Vallabh M}, Ganesh` (BibTeX) |
| SPELL-03 | [`readme.md:369`](readme.md#L369) | 369 | `98.4% Accuracy (Macro F1: 0.98)` | `98.56% Accuracy (Macro F1: 0.90)` |
| SPELL-04 | [`readme.md:371`](readme.md#L371) | 371 | `RMSE: +/- 14.2 m` | `RMSE: ±24.2 m` |
| SPELL-05 | [`dashboard.html:6`](frontend/dashboard.html#L6) | 6 | `- UNIVERSE TELEMETRY` | `- Mission Control` (or remove) |
...
### D1 — Dual-tier ML architecture for resource-constrained aerospace systems [High Priority]
...
### D2 — ExtraTrees sensor calibration achieving altitude R² = 1.0000 (RMSE: 0.804 m) [High Priority]
...
### D3 — Savitzky-Golay kinematic estimator for flight dynamics profiling [Medium Priority]
...
### D4 — Safe Landing Area Index (SLAI) 3×3 hazard grid evaluation [High Priority]
...
### D5 — 10 synthesized test flight scenarios with per-scenario analysis [Medium Priority]
...
### D6 — Altitude Kalman Filter with adaptive IMU fusion [Medium Priority]
...
|---|---|---|
| [P1] **P1** | [`readme.md`](readme.md) | Fix BUG-03 (accuracy 98.4% → 98.56%, Macro F1 0.98 → 0.90), BUG-04 (RMSE 14.2 m → 24.2 m) |
| [P1] **P1** | [`frontend/tinyml.html`](frontend/tinyml.html) | Fix BUG-01 (64×48 → 64×64) |
| [P1] **P1** | [`frontend/js/mission-slider.js`](frontend/js/mission-slider.js) | Fix BUG-01 (64×48 → 64×64) |
| [P1] **P1** | [`frontend/index.html`](frontend/index.html) | Fix BUG-01 (code comment 64×48 → 64×64), SPELL-01 ("Droplibs" rename) |
| [P2] **P2** | [`frontend/models.html`](frontend/models.html) | Fix BUG-02 (6,996 → 7,320 for INT8, or clarify distinction) |
| [P2] **P2** | [`frontend/results.html`](frontend/results.html) | Fix SPELL-02 (BibTeX author name) |
| [P3] **P3** | [`frontend/dashboard.html`](frontend/dashboard.html) | Fix BUG-06 (title UNIVERSE TELEMETRY), BUG-07 (hard-coded COM ports) |
